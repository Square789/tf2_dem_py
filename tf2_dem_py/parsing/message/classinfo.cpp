...
void ClassInfo::parse(CharArrayWrapper *caw, ParserState_c *parser_state, PyObject *root_dict) {
	this->skip(caw, parser_state);
}

void ClassInfo::skip(CharArrayWrapper *caw, ParserState_c *parser_state) {
