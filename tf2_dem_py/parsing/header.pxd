...
from chararray_wrapper cimport CharArrayWrapper as CyCAW
#from tf2_dem_py.parsing.chararray_wrapper import CharArrayWrapper as PyCAW

cdef inline dict parse(FILE *stream):
